        ...
        <div className="max-w-5xl mx-auto my-16 bg-surface border border-border-light rounded-2xl shadow-xl p-6 md:p-8 transition-all duration-300 transform hover:-translate-y-1">
            ...
            <div className="flex flex-col items-center text-center mb-6">
                <div className="flex items-center justify-center gap-3 mb-2">
                    <Icon name="studio" className="h-8 w-8 md:h-10 md:w-10 text-teal" />
                    <h2 className="text-xl md:text-2xl font-bold text-text-dark uppercase tracking-wider">{t('studioTitle')}</h2>
                </div>
                <p className="text-sm md:text-base text-text-light">{t('studioSubtitle')}</p>
            </div>
