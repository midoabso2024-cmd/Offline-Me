    ...
    >
        ...
        <div className="container mx-auto px-4 h-16 flex items-center relative z-10">
            ...
            <div className="absolute left-4 top-1/2 -translate-y-1/2 flex items-center gap-3 md:gap-4" dir="ltr">
                ...
                >
                    {/* Image Logo - Square with rounded corners, larger size */}
                    <img 
                        ...
                        alt="Offline-Me"
                        className="h-14 w-14 md:h-16 md:w-16 rounded-xl object-cover border-2 border-white/20 shadow-md transition-transform duration-300 group-hover:scale-105"
                    />
                </button>
